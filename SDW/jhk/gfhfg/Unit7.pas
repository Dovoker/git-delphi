...
begin
  ...
  begin
    ...
    begin
      MessageBox(handle, PChar('Поздравляем,вы успешно вошли в пентагон.'),
        PChar('Здраствуйте:D'), MB_ICONASTERISK + MB_OK);
      Form7.Visible := False;
      Form1.Visible := True;
      Form1.Show;
    end
    ...
    begin
      MessageBox(handle, PChar('Логин или пароль указан не верно!Проверьте правильность в ведение символов и повторите попытку.'),
    ...
    MessageBox(handle, PChar('Поля логин или пароль должны быть заполнены!'),
...
button1.Enabled:=length(Edit1.Text)<=10;
end;
